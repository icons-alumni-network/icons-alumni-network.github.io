...
function addMarker(i, markers, map) {
	if (i >= alumniLocations.length) {
		return;
	}

	var pos = { lat: alumniLocations[i], lng: alumniLocations[i+1] };
	...
	setTimeout(addMarker.bind(this, i + 2, markers, map), 20);
}

var addAllMarkers = addMarker.bind(this, 0);
